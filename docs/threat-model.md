...
| Unsichere Passwortspeicherung | Hoch | bcrypt-Hashing, keine Klartextspeicherung |
| bcrypt-Passworttrunkierung | Mittel | Passwort wird vor Hash/Verify auf maximal 72 UTF-8-Bytes begrenzt |
